import  {loadForms,loadLayer,returnProjetos,retornaListAreaCode,returnEditFeatures,applyEditsToLayer,findField,hideFields,lockFieldsTable} from '../Consultas'
import {convertKmlToGeoJson,convert2D} from './01-convert-kmz-data.js'
import {verifyAprovacao} from "./02.1-justificativa.js"
import SucessMessage,{AlertMessage} from '../../components/SucessMessage'; // Importe o componente aqui.
